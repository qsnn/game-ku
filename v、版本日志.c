...
{
	system("cls");
	printf("v1.0:将猜数字整合，正在制作其他游戏\n");
	printf("v1.1:将三子棋整合，优化整体代码结构。正在制作其他游戏\n");
	printf("v1.2:优化三子棋代码结构\n");
	...
	printf("v2.0.0:优化扫雷游戏局面显示，添加音乐，全面优化背景音乐的资源占用\n");
	system("pause");
}
...
void gnversion()
{
	...
	printf("4.1：改进提示语，修复因输入小数而导致程序错误的问题\n");
	printf("4.2：优化背景音乐的资源占用\n");
}
...
void saoleiversion()
{
	...
	printf("2.0：优化局面显示，添加sao好听的背景音乐，优化背景音乐的资源占用\n");
	system("pause");
}